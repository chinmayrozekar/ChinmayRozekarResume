...
\small Wilsonville, OR $|$ \href{mailto:chinmay.rozekar@gmail.com}{chinmay.rozekar@gmail.com} $|$
\href{https://www.linkedin.com/in/chinmayrozekar}{linkedin.com/in/chinmayrozekar} $|$
\href{https://github.com/chinmayrozekar}{github.com/chinmayrozekar}
...
% Software QA Engineer with 5+ years of experience across semiconductor validation, EDA automation, and cleanroom-based test operations, integrating AI/ML workflows to enhance reliability analysis and regression efficiency.
...
\vspace{2pt}
\begin{itemize}[leftmargin=0.15in,label={}]
\small\item{AI first Software Engineer with 5+ years across semiconductor validation, fab-adjacent automation, and cleanroom experience (RIT SMFL). Adept in Automation, Python tooling and dashboards for trend detection and change-point triage. 
Practical AI experience (LLMs, RAG) used to accelerate data analysis and QA automation.}
\end{itemize}
...
\textbf{\blue{Languages}}{: Python, Tcl/Tk, Shell, SVRF, C/C++, Perl, Java, Awk} \\
...
\textbf{\blue{Statistical Analysis}}{: SPC, Cp/Cpk, box plots, parametric yield analysis} \\
\textbf{\blue{Fabrication \& Lab Experience}}{: Cleanroom protocol compliance (Class 100/1000), ESD handling, wafer-level diagnostics, probe station and handler operation} \\
...
\resumeSubheading{\blue{Software QA Engineer}}{July 2024 -- October 2025}{\blue{Siemens EDA (Mentor Graphics)}}{Wilsonville, OR}
\resumeItemListStart
\resumeItem{Owned QA reliability verification for Calibre PERC (LDL, topology, voltage propagation, point-to-point resistance, current density), maintaining reproducible testcases and baselines across single and multi-threaded modes.}
\resumeItem{Collaborated with developers to debug MTFlex issues (turbo/EV mismatches, rule-group sequencing); enhanced pre-run environment validation to ensure PERC LOAD options and LDL scopes are consistently honored.}
...
\resumeItem{Authored QA runbooks, grid execution guidelines, and onboarding documentation, reducing new-hire ramp-up time by approximately \textbf{30\%}.}

% \resumeItem{Owned reliability-verification QA for Calibre PERC (LDL, topology, voltage propagation, P2P resistance, current density) with reproducible baselines across ST/MT.}
% \resumeItem{Automated regression setup and log analysis with Bash/Tcl/Python, cutting setup/debug by \textbf{20\%} and reducing nightly flakes by \textbf{15\%}.}
% \resumeItem{Implemented distributed submissions on Terra with priority tuning and post-run KPI publishing for runtime, memory, and coverage visibility.}
% \resumeItem{Built Python parsers to generate SPC-style control charts and Cp/Cpk on regression KPIs, enabling change-point triage for release gates.}
% \resumeItem{Validated sequential and distributed rule execution and reproduced customer issues with minimal repro testcases for faster R\&D triage.}
% \resumeItem{Authored runbooks and onboarding guides that shortened ramp by \textbf{~30\%}.}
...
\resumeItem{Led post-silicon SLT for Ryzen 8040 APUs across 14+ IPs and multiple platforms, coordinating bring-up through qualification.}
\resumeItem{Developed production test programs for electrical/thermal characterization (IR drop, current draw, power margins) to meet spec.}
\resumeItem{Automated data capture and STDF parsing with Python/Perl, cutting manual analysis by \textbf{40\%} and speeding yield feedback.}
\resumeItem{Executed SIDD, margin, and stress screens to flag borderline parts and tighten early screening.}
\resumeItem{Applied DOE to isolate parametric drift; stabilized ramp by optimizing test sequencing for \textbf{10\%} throughput gain.}
\resumeItem{Built Power BI dashboards for KPI tracking; reduced triage and time to completion by \textbf{30\%}.}
\resumeItemListEnd


\resumeSubheading{\blue{Product Engineering Co-Op}}{July 2019 -- December 2019}{\blue{Advanced Micro Devices (AMD)}}{Austin, TX}
\resumeItemListStart
% \resumeItem{Designed and automated test programs for Human Body Model Testing, reducing Engineering time by 90\%.}
% \resumeItem{Reverse-engineered and redesigned a 20-year-old robotic graphical user interface in Python, reducing engineering
% time by 95\%.}
...
\resumeItem{Automated Human Body Model ESD test programs; reduced engineering time by \textbf{90\%}.}
\resumeItem{Performed calibration and waveform verification for preventive maintenance per ISO 9000 procedures.}
\resumeItem{Designed DOE for capacitive modeling to optimize protection circuitry and improve first-pass yield.}

\resumeItemListEnd



% \resumeSubheading{\blue{Graduate Research Assistant -- Process Engineering}}{January 2020 -- May 2020}{\blue{RIT Semiconductor and Microsystems Fabrication Laboratory (SMFL)}}{Rochester, NY}
% \resumeItemListStart
...
\resumeSubheading{\blue{Graduate Research Assistant — Process Engineering}}{January 2020 -- May 2020}{\blue{RIT Semiconductor \& Microsystems Fabrication Laboratory (SMFL)}}{Rochester, NY}
\resumeItemListStart
\resumeItem{Developed a complete thin-film IC process flow within the SMFL cleanroom, covering lithography, deposition, and etch steps.}
% \resumeItem{Designed and simulated NMOS devices to analyze sub-threshold behavior and model leakage current characteristics.}
\resumeItem{Simulated NMOS devices to analyze subthreshold slope and leakage.}
\resumeItem{Performed electrical characterization to optimize gate oxide growth and achieve desired device threshold profiles.}
\resumeItemListEnd
...
% \item \large{\textbf{Data Science }}
	...
	\resumeSubSubheading{\textbf{\blue{MEMS Silicon Micro-robot}}}{}
	\resumeItemListStart
	\resumeItem{Designed and fabricated thermally actuated MEMS micro-robot inside the Semiconductor \& Microsystems Fabrication Laboratory (SMFL) cleanroom at RIT, following Class-100/1000 contamination-control procedures.}
	\resumeItem{Utilized CAD/SolidWorks for device layout and COMSOL Multiphysics for heat-transfer and actuation simulation, validating design feasibility prior to fabrication.}
	\resumeItemListEnd
...
{Post Graduate Program in Artificial Intelligence and Machine Learning  }{2025}
