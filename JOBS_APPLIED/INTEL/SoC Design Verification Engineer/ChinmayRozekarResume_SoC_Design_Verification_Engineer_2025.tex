...
\resumeItem{Delivered clean regression baselines with $>$90\% testcase coverage, directly supporting quarterly Calibre PERC product releases and customer reliability decks.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
        ...
        \textbf{DevOps}{: Docker, CI/CD, Git, Hugging Face Spaces, MLOps} \\
        \textbf{Tools}{: Vim, VS Code, Jupyter, CVS, Jira, Confluence} \\
...
\vspace{5pt}
% \item \textbf{ Pipeline }
	\resumeSubSubheading{\textbf{End-to-End ML Pipeline Project}}{}
	\resumeItemListStart
